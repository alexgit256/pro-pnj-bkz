...
#machine A and machine C: max_RAM = 1.5 TB, set max_RAM = 43 log2(bit) = 1.5TB 
...
# python ProPnjBKZ_for_lwe.py 40 --lwe/alpha 0.040 --gpus 2 --threads 32 --verbose True --pump/down_sieve True  --strategy_method "enumbs" --load_lwe "lwe_challenge" --float_type "dd" --gen_strategy_only 1 --max_RAM 43 | tee "strategy-for-unsolved-lwechal"/40-040.log

# python ProPnjBKZ_for_lwe.py 50 --lwe/alpha 0.025 --gpus 2 --threads 32 --verbose True --pump/down_sieve True  --strategy_method "enumbs" --load_lwe "lwe_challenge" --float_type "dd" --gen_strategy_only 1 --max_RAM 43 | tee "strategy-for-unsolved-lwechal"/50-025.log

# python ProPnjBKZ_for_lwe.py 55 --lwe/alpha 0.020 --gpus 2 --threads 32 --verbose True --pump/down_sieve True  --strategy_method "enumbs" --load_lwe "lwe_challenge" --float_type "dd" --gen_strategy_only 1 --max_RAM 43 | tee "strategy-for-unsolved-lwechal"/55-020.log
