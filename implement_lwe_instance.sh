...
do
    ...
    # # python lwe_instance.py $i --lwe/alpha 0.015 --threads 32 --gpus 2 --verbose True --pump/down_sieve True  | tee "lwe-instance-test"/"lwe-instance-test-new-cost-modelv2"/"default_g6k_main(32+2gpus)"/$i-015-${j}.log
    ...
    # python ProPnjBKZ_for_lwe.py ${i} --lwe/alpha 0.015 --gpus 2 --threads 32 --verbose True --pump/down_sieve True  --strategy_method "enumbs" --load_lwe "lwe_instance" --float_type "dd"| tee "lwe-instance-test"/"lwe-instance-test-new-cost-modelv2"/"d4f-default-g6k"/"enumbs(32+2gpus)"/${i}-015-${j}.log
    ...
    # python ProPnjBKZ_for_lwe.py ${i} --lwe/alpha 0.015 --gpus 2 --threads 32 --verbose True --pump/down_sieve True  --strategy_method "bssav1" --load_lwe "lwe_instance" --float_type "dd"| tee "lwe-instance-test"/"lwe-instance-test-new-cost-modelv2"/"d4f-default-g6k"/"bssa(32+2gpus)"/${i}-015-${j}.log
    # done
done
