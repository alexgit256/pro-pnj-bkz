export LD_LIBRARY_PATH="./:/usr/local/lib/:/usr/lib/x86_64-linux-gnu/:/usr/bin/:/usrlib/"
...
g++ -O3 -funroll-loops -o lwechal-enumbs-est ./lwe-est/lwechal-enumbs-parallel-est.cpp  -pthread -L/home/cryptothesis/summer/pro-pnj-bkz/strategy_gen/framework -Wl,-rpath=/home/cryptothesis/summer/pro-pnj-bkz/strategy_gen/framework -lpthread -lalglib -lcurl -lfplll -lmpfr -lgmp -lest
...
g++ -O3 -funroll-loops -o lwechal-bssa-est ./lwe-est/lwechal-bssa-est.cpp -L/home/cryptothesis/summer/pro-pnj-bkz/strategy_gen/framework -Wl,-rpath=/home/cryptothesis/summer/pro-pnj-bkz/strategy_gen/framework -lpthread -lalglib -lcurl -lfplll -lmpfr -lgmp -lest
